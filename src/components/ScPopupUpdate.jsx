...
const PopupUpdate = (props) => {
	...
	function update() {
		axios
			.put(`http://localhost:8080/update/${locationState.id}`, {
				name: sname,
		...
		<div className="text-center  transition-all top-56 w-full h-full">
			<div className="p-8  bg-white align-center relative">
				<div className="transition-all ">
					<form>
						<p className="text-3xl ">Update form</p>
						<br />
						<div className="">
							<label
							...
							<img
								src={
									baseImage !== null
										? baseImage
										: setBaseImage("https://via.placeholder.com/400")
								}
								className=" mx-auto m-5 w-56 h-80"
								alt="userInput"
							></img>
							<input
								type="file"
							...
							<textarea
								rows="4"
								cols="50"
								className="p-2.5 text-sm text-gray-900 bg-gray-200 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
								id="updatedDesc"
