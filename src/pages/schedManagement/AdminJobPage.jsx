							...
							<div className="flex-grow flex flex-col h-full pt-4">
								<div className="flex-1 flex gap-2">
									...
									<div className="flex-1 flex flex-col gap-2">
										...
										<div className="h-1/4 border rounded flex flex-col pb-2 text-sm font-medium relative">
											<div className="flex flex-col gap-1 flex-1 px-6 pt-4">
												<div className="flex flex-row justify-between text-xl">
													<div className="bg-slate-100 text-slate-600 py-1 px-4 rounded ">
														#{job?.client?.id}
													</div>
													<div className="flex flex-row">
														<Button
															...
															onClick={() =>
																navigate(
																	`${USER_PAGE_URL}?email=${job?.client?.email}`
																)
															}
														>
															Goto User Page
										...
										<div className="h-1/4 border rounded flex flex-col pb-2 text-sm font-medium relative">
											{job?.review === null ? (
												<div className="h-full w-full flex bg-black  bg-opacity-10 items-center justify-center absolute text-gray-500">
													Client has not left a review.
												</div>
											) : (
												<div className="h-1/4 flex flex-col gap-1 flex-1 px-6 pt-4">
													<div className="flex flex-row">
