...
function ServiceDeatials() {
  ...
  return (
    <form className="shadow-2xl border-2 border-gray m-5 p-10">
      <div>
        <h1 className="mb-4 text-4xl font-extrabold tracking-tight leading-none text-gray-900  lg:text-3xl dark:text-black">
          {locationState.name}
        </h1>
        <br />
        <div className="flex ">
          ...
          <div className="m-2 hover:scale-125 shadow-2xl border-2 border-gray w-64 rounded-xl">
            <img
              ...
              className=" mx-auto m-2  w-56 h-80 shadow rounded-xl align-middle border-none"
              alt="img"
            ></img>
            <div className="m-4 text-sm ">
              ...
              <p>
                ...
                {locationState.category} Cleaning
              </p>
              <p>
                <span className=" text-gray-500">Service price:</span> Rs.
                {locationState.price}.00
              </p>
            </div>
          </div>
        </div>
