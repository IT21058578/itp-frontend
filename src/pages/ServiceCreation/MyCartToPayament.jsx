...
function MyCartToPayament() {
  ...
  function validatePayment(e) {
    ...
    let hasAnyErr = false;
    var dif =
      (new window.Date("1970-1-1 " + ETime) -
        new window.Date("1970-1-1 " + STime)) /
      1000 /
      60 /
      60;
  ...
  function saveInvoice() {
    const options = {
      ...
      data: {
        ...
        address: "No 3, SLIIT Road, Malabe",
        services: [
          {
            name: "Apartment Cleaning",
            imgUrl: "../images/two.jpg",
            desc: "short description about Apartment Cleaning",
            basicPrice: 12000,
          },
          {
            name: "Office Cleaning",
            imgUrl: "../images/two.jpg",
            desc: "short description about office Cleaning",
            basicPrice: 3000,
          },
        ],
        invoiceDate: "2022-11-06",
        paymentStatus: false,
      },
    };
  ...
  const crews = ["CREW 01", "CREW 02", "CREW 03", "CREW 05", "CREW 05"];
  return (
    <div className="w-2/6 p-8 flex flex-col items-center justify-center">
      ...
      <div className="flex w-full flex-col gap-2">
        ...
        <Select defaultValue={crew} onChange={(e) => setCrew(e.target.value)}>
          {crews &&
            crews.map((item, i) => (
